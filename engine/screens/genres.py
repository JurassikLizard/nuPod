"""Music/Genres screen — placeholder until genre metadata is available.

Shows a single "No genres available" message.
"""
...
class GenresScreen(ListScreen):
    """Music > Genres: placeholder."""

    def __init__(self):
        super().__init__()
        self._items = [{"label": "No genres available", "id": "empty"}]
