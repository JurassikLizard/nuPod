"""Music/Playlists screen — placeholder until playlist support is added.

Shows a single "No playlists available" message.
"""
...
class PlaylistsScreen(ListScreen):
    """Music > Playlists: placeholder."""

    def __init__(self):
        super().__init__()
        self._items = [{"label": "No playlists available", "id": "empty"}]
